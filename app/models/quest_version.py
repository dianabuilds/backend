...
class QuestVersion(Base):
    ...
    number = Column(Integer, nullable=False, default=1)  # порядковый номер версии
    status = Column(String, nullable=False, default="draft")  # draft|released|archived
...
class QuestGraphNode(Base):
    ...
    key = Column(String, nullable=False)  # уникален в рамках версии
    title = Column(String, nullable=False)
    type = Column(String, nullable=False, default="normal")  # start|normal|end
