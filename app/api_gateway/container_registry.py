...
_REGISTRY_ENTRIES = {
    ...
    "product.profile.SQLRepo": "domains.product.profile.adapters.sql.repository:create_repo",
    "product.profile.Service": "domains.product.profile.application.services:Service",
    "product.tags.SQLRepo": "domains.product.tags.adapters.sql.repository:create_repo",
    "product.tags.TagUsageStore": "domains.product.tags.adapters.memory.store:TagUsageStore",
    "product.tags.register_usage_writer": "domains.product.tags.adapters.sql.usage_writer:register_tags_usage_writer",
    "product.tags.SQLTagCatalog": "domains.product.tags.adapters.sql.tag_catalog:SQLTagCatalog",
    "product.tags.TagService": "domains.product.tags.application.service:TagService",
    "product.nodes.SQLRepo": "domains.product.nodes.adapters.sql.repository:create_repo",
    "product.nodes.SQLNodeViewsRepo": "domains.product.nodes.adapters.sql.views:create_repo",
    "product.nodes.SQLNodeReactionsRepo": "domains.product.nodes.adapters.sql.reactions:create_repo",
    "product.nodes.SQLNodeCommentsRepo": "domains.product.nodes.adapters.sql.comments:create_repo",
    "product.nodes.RedisNodeViewLimiter": "domains.product.nodes.adapters:RedisNodeViewLimiter",
    "product.nodes.MemoryTagCatalog": "domains.product.nodes.adapters.memory.tag_catalog:MemoryTagCatalog",
    "product.nodes.MemoryUsageProjection": "domains.product.nodes.adapters.memory.usage:MemoryUsageProjection",
    "product.nodes.SQLUsageProjection": "domains.product.nodes.adapters.sql.usage:create_projection",
    "product.nodes.TagUsageStore": "domains.product.tags.adapters.memory.store:TagUsageStore",
    ...
    "product.achievements.SQLRepo": "domains.product.achievements.adapters.sql.repository:create_repo",
    ...
    "product.worlds.SQLRepo": "domains.product.worlds.adapters.sql.repository:create_repo",
    "product.worlds.Service": "domains.product.worlds.application.service:WorldsService",
    "product.referrals.SQLRepo": "domains.product.referrals.adapters.sql.repository:create_repo",
    ...
    "product.quests.SQLRepo": "domains.product.quests.adapters.sql.repository:create_repo",
    "product.quests.Service": "domains.product.quests.application.service:QuestService",
    "product.moderation.SQLRepo": "domains.product.moderation.adapters.sql.repository:create_repo",
