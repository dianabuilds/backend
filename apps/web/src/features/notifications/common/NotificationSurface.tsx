...
const SURFACE_BASE =
  'rounded-3xl border border-white/60 bg-gradient-to-br from-indigo-50 via-white to-indigo-100 shadow-[0_30px_60px_-25px_rgba(79,70,229,0.45)] backdrop-blur-xl dark:border-dark-600/70 dark:from-dark-700/80 dark:via-dark-750/80 dark:to-dark-800/90';
