...
export type NodesFiltersProps = {
  ...
  statusOptions: Array<{ value: NodeStatusFilter; label: string }>;
  loading: boolean;
  authorId: string;
  authorQuery: string;
  userOptions: NodeUserOption[];
  ...
  onOrderChange: (value: NodeSortOrder) => void;
  onStatusChange: (value: NodeStatusFilter) => void;
  onAuthorChange: (value: string) => void;
  onAuthorFocus: () => void;
  onAuthorSelect: (option: NodeUserOption) => void;
  onAuthorClear: () => void;
  onCreateNode: () => void;
  onImportExport: () => void;
  onAnnounce: () => void;
      ...
      <div className="flex flex-wrap items-center gap-3 text-sm">
        <div className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-1.5 dark:border-dark-500 dark:bg-dark-700">
          ...
          <select
            ...
            value={status}
            onChange={(e) => onStatusChange(e.target.value as NodeStatusFilter)}
          >
