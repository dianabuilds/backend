...
const ManagementSiteBlockDetailPage = React.lazy(() => import('../pages/management/SiteBlockDetail'));
  ...
  return (
    <PrivateProviders>
      <Routes>
        ...
        />
        <Route
          path="/management/site-editor/blocks/:blockId"
          element={withLayout(<ManagementSiteBlockDetailPage />, { requireAdmin: true })}
        />
        <Route
