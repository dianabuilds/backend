  ...
  describe('fetchNodesList', () => {
    it('normalizes list responses with metadata and filters params', async () => {
          ...
          items: [
            {
              ...
              moderation_status_updated_at: '2025-10-05T12:15:00Z',
            },
            {
              id: 'node-2',
              title: null,
              ...
              moderation_status_updated_at: null,
            },
          ],
          total: '10',
          has_next: 'true',
      ...
      const result = await fetchNodesList({
        ...
        sort: 'status',
        order: 'asc',
        updatedFrom: ' 2025-10-01 ',
        updatedTo: ' 2025-10-11 ',
        limit: 15,
        offset: 30,
      });

      expect(mockedApiGet).toHaveBeenCalledWith(
        '/v1/admin/nodes/list?q=test&slug=sluggy&limit=15&offset=30&sort=status&order=asc&status=draft&moderation_status=pending&tag=dev-blog&author_id=author-1&updated_from=2025-10-01&updated_to=2025-10-11',
        { signal: undefined },
      );
