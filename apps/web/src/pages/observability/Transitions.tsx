...
import { fetchTransitionsSummary } from './api';
import { useTelemetryQuery } from './useTelemetryQuery';
import { TransitionModeSummary } from './types';
...
export default function ObservabilityTransitions() {
  ...
  const { data, loading, error, refresh } = useTelemetryQuery<TransitionModeSummary[]>({
