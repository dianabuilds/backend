...
class MemoryRefreshTokenStore:
    ...
    This implementation is primarily intended for tests and
    single-process deployments. It is safe to replace with a
    distributed store (e.g. Redis) by providing an object that
    satisfies :class:`RefreshTokenStore`.
    """
