...
class IAchievementsRepository(Protocol):
    ...
    async def list_user_achievements(self, user_id: UUID) -> list[tuple[Achievement, UserAchievement | None]]:  # pragma: no cover
        ...
    ...
    async def create_achievement(self, data: dict[str, Any], actor_id: UUID) -> Achievement:  # pragma: no cover
        ...

    async def update_achievement_fields(self, item: Achievement, data: dict[str, Any], actor_id: UUID) -> Achievement:  # pragma: no cover
        ...
