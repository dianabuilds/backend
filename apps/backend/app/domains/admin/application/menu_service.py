...
BASE_MENU: List[dict] = [
    ...
    },
    {
        ...
        "order": 3,
        "children": [
            {"id": "nodes", "label": "Nodes", "path": "/nodes", "icon": "nodes", "order": 1},
            {"id": "tags", "label": "Tags", "path": "/tags", "icon": "tags", "order": 2},
            {
                "id": "quests",
                "label": "Quests",
                "path": "/quests",
    ...
    },
    {
        ...
        "children": [
            ...
            {"id": "nav-traces", "label": "Traces", "path": "/traces", "icon": "traces", "order": 4},
        ],
    },
    {
        "id": "ai-quests",
        ...
        "order": 5,
        "children": [
            {"id": "ai-quests-main", "label": "Generator", "path": "/ai/quests", "icon": "ai", "order": 1},
            {"id": "ai-worlds", "label": "Worlds", "path": "/ai/worlds", "icon": "nodes", "order": 2},
            {"id": "ai-settings", "label": "AI Settings", "path": "/ai/settings", "icon": "ai", "order": 3},
            {"id": "ai-rate-limits", "label": "Rate limits", "path": "/ai/rate-limits", "icon": "rate-limit", "order": 4},
        ],
    },
    {
        "id": "telemetry",
    ...
    },
    {
        ...
        "roles": ["admin"],
        "children": [
            {"id": "premium-plans", "label": "Plans", "path": "/premium/plans", "icon": "payments", "order": 1},
            {"id": "premium-limits", "label": "Limits", "path": "/premium/limits", "icon": "rate-limit", "order": 2},
        ],
    },
    {
        "id": "tools",
        ...
        "roles": ["admin"],
        "children": [
            {"id": "cache", "label": "Cache", "path": "/tools/cache", "icon": "cache", "order": 1},
            {"id": "rate-limit", "label": "Rate limit", "path": "/tools/rate-limit", "icon": "rate-limit", "order": 2},
            {"id": "restrictions", "label": "Restrictions", "path": "/tools/restrictions", "icon": "restrictions", "order": 3},
    ...
    },
    {
        ...
        "order": 7,
        "roles": ["admin"],
        "children": [{"id": "health", "label": "Health", "path": "/system/health", "icon": "health", "order": 1}],
    },
    {
    ...
    {"id": "quests-top", "label": "Quests", "path": "/quests", "icon": "quests", "order": 3, "hidden": True},
    {
        "id": "payments",
        "label": "Payments",
        "icon": "payments",
        ...
        "children": [
            {"id": "payments-gateways", "label": "Gateways", "path": "/payments", "icon": "payments", "order": 1},
            {"id": "payments-transactions", "label": "Transactions", "path": "/payments/transactions", "icon": "audit", "order": 2},
        ],
    },
    {
        "id": "achievements-top",
