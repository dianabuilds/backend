...
class ReferralCode(Base):
    ...
    created_by_user_id = sa.Column(UUID(), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
    updated_by_user_id = sa.Column(UUID(), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
...
class ReferralEvent(Base):
    ...
    referee_user_id = sa.Column(UUID(), sa.ForeignKey("users.id", ondelete="CASCADE"), nullable=False, index=True)
