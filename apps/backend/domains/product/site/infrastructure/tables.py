...
REVIEW_STATUS_ENUM = _enum([member.value for member in PageReviewStatus], "site_page_review_status")
...
SITE_PAGE_DRAFTS_TABLE = sa.Table(
    ...
    sa.Column(
        "page_id",
        sa.Uuid(as_uuid=True),
        sa.ForeignKey("site_pages.id", ondelete="CASCADE", name="fk_site_page_drafts_page"),
        primary_key=True,
        nullable=False,
    ),
    ...
    sa.Column("review_status", REVIEW_STATUS_ENUM, nullable=False, default=PageReviewStatus.NONE),
    sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, default=_utcnow),
...
SITE_PAGE_VERSIONS_TABLE = sa.Table(
    ...
    sa.Column(
        "page_id",
        sa.Uuid(as_uuid=True),
        sa.ForeignKey("site_pages.id", ondelete="CASCADE", name="fk_site_page_versions_page"),
        nullable=False,
    ),
    ...
    sa.Column("published_at", sa.DateTime(timezone=True), nullable=False, default=_utcnow),
...
SITE_GLOBAL_BLOCKS_TABLE = sa.Table(
    ...
    sa.Column("status", BLOCK_STATUS_ENUM, nullable=False, default=GlobalBlockStatus.DRAFT),
    sa.Column("review_status", REVIEW_STATUS_ENUM, nullable=False, default=PageReviewStatus.NONE),
    sa.Column("data", JSON_TYPE, nullable=False, default=dict),
    sa.Column("meta", JSON_TYPE, nullable=False, default=dict),
    sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, default=_utcnow),
...
SITE_GLOBAL_BLOCK_USAGE_TABLE = sa.Table(
    ...
    sa.Column(
        "page_id",
        sa.Uuid(as_uuid=True),
        sa.ForeignKey("site_pages.id", ondelete="CASCADE", name="fk_site_global_block_usage_page"),
        primary_key=True,
        nullable=False,
    ),
...
SITE_PAGE_METRICS_TABLE = sa.Table(
    ...
    sa.Column(
        "page_id",
        sa.Uuid(as_uuid=True),
        sa.ForeignKey("site_pages.id", ondelete="CASCADE", name="fk_site_page_metrics_page"),
        primary_key=True,
        nullable=False,
    ),
    ...
    sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, default=_utcnow),
    sa.Column(
        "updated_at", sa.DateTime(timezone=True), nullable=False, default=_utcnow, onupdate=_utcnow
    ),
)
...
SITE_GLOBAL_BLOCK_METRICS_TABLE = sa.Table(
    ...
    sa.Column(
        ...
        sa.Uuid(as_uuid=True),
        sa.ForeignKey(
            "site_global_blocks.id", ondelete="CASCADE", name="fk_site_global_block_metrics_block"
        ),
        primary_key=True,
        nullable=False,
    ),
...
sa.Index(
    "ix_site_audit_entity", SITE_AUDIT_LOG_TABLE.c.entity_type, SITE_AUDIT_LOG_TABLE.c.entity_id
)
