...
from apps.backendDDD.domains.product.profile.adapters.repo_sql import SQLProfileRepo
from apps.backendDDD.domains.product.nodes.adapters.repo_sql import SQLNodesRepo
from apps.backendDDD.domains.product.quests.adapters.repo_sql import SQLQuestsRepo
from apps.backendDDD.domains.product.tags.adapters.repo_sql import SQLTagsRepo
from apps.backendDDD.domains.product.tags.adapters.usage_sql_writer import (
...
from apps.backendDDD.domains.product.achievements.adapters.repo_sql import (
...
from apps.backendDDD.domains.product.worlds.adapters.repo_sql import SQLWorldsRepo
from apps.backendDDD.domains.product.moderation.adapters.repo_sql import SQLModerationRepo
from apps.backendDDD.domains.product.referrals.adapters.repo_sql import SQLReferralsRepo
from apps.backendDDD.domains.product.navigation.application.ports import (
...
def build_container(env: str = "dev") -> Container:
    ...
    try:
        from apps.backendDDD.packages.core.config import to_async_dsn as _to_async
