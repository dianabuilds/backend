...
from apps.backendDDD.domains.product.nodes.application.ports import UsageProjection
from apps.backendDDD.domains.product.tags.adapters.store_memory import TagUsageStore
