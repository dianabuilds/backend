...
from apps.backendDDD.domains.platform.search.adapters.cache_memory import (
    InMemorySearchCache,
)
from apps.backendDDD.domains.platform.search.adapters.cache_redis import (
    RedisSearchCache,
)
from apps.backendDDD.domains.platform.search.adapters.memory_index import InMemoryIndex
from apps.backendDDD.domains.platform.search.adapters.persist_file import (
    FileSearchPersistence,
)
from apps.backendDDD.domains.platform.search.application.service import SearchService
