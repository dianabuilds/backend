...
export class AdminTagsService {
   ...
   * @throws ApiError
   */
  public static delAliasAdminTagsAliasesAliasIdDelete(aliasId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static mergeTagsAdminTagsMergePost(requestBody: MergeIn): CancelablePromise<MergeReport> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static deleteBlacklistAdminTagsBlacklistSlugDelete(slug: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public static createTagAdminTagsPost(requestBody: TagCreate): CancelablePromise<TagListItem> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/admin/tags/',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static deleteTagAdminTagsTagIdDelete(tagId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'DELETE',
